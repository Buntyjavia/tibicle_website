...
<div class="project-details-container ml-180">
    <div class="project-details-content">
        <div class="project-details">
            <div >
                <div class="title">WE AMOR</div>
                <div class="details-section">
                    <div class="left-side">
                        <div class="sub-title">Info</div>
                        <p>
                            If you're seeking a soulmate, a kindred spirit, 
                            or a new adventure, We Amor is here to bring 
                            people together in a meaningful and enjoyable way!
                        </p>
                    </div>
                    ...
                    <div class="technologies-content">
                        <div class="technologies">
                            <div class="technologies-name">
                                <img src="<?php echo get_template_directory_uri(); ?>/asset/img/flutter.svg" alt="flutter-icon">
                            </div>
                            <div class="technologies-name">Flutter</div>
                        </div>
                        <div class="technologies">
                            <div class="technologies-name">
                                <img src="<?php echo get_template_directory_uri(); ?>/asset/img/node-js.svg" alt="Node-js-icon">
                            </div>
                            <div class="technologies-name">Node.js</div>
                        </div>
                        <div class="technologies">
                            <div class="technologies-name">
                                <img src="<?php echo get_template_directory_uri(); ?>/asset/img/postgresql.svg" alt="postgresql-icon">
                            </div>
                            <div class="technologies-name">PostgreSQL</div>
                        </div>
                    </div>
                </div>
                <p>Download now,</p>
